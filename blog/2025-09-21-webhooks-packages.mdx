...
A few weeks back I became aware of an attempt to create a technology agnostic standard to send and receive webhooks securely. The proposal is [here](https://github.com/standard-webhooks/standard-webhooks/blob/main/spec/standard-webhooks.mdx). 
