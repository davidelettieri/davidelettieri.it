...
This is an update on [this post](2024-02-04-fedora-pipewire-switch-channels.mdx), on wireplumber v0.5 lua configuration files are not supported anymore. To switch channels on v0.5 you have to create the following file
