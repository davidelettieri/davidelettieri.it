...
Ported from the Android Studio template, quick and easy the [Navigation Drawer](2017-10-07-xamarin-navigation-drawer.mdx "Navigation Drawer porting from Android Studio") was way harder than this.
