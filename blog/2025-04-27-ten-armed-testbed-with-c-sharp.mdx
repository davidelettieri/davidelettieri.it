...
In a [previous post](2025-03-16-tic-tac-toe-reinforcement-learning-with-c-sharp.mdx) I reproduced the tic-tac-toe example with some improvements and clarification with respect to the original text. I think it's worth taking a look at it.
