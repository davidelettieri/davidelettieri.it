...
1. [A tagged union example](2020-03-21-a-tagged-union-example.mdx)
2. [Railway oriented programming with C#](2020-04-04-railway-oriented-programming-with-c-sharp.mdx)
